...
<body style="background-color: #FFFAFA;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <form class="row g-3" method="POST" action="phpfiles/regpt.php" id="regForm"> 
          ...
          <div class="col-sm-6">
            <label for="inputState" class="form-label">Living Status</label>
            <select id="inputState" class="form-select"name='diseased'>
              <option selected value="0">Live</option>
          ...
          <div class="col-sm-6">
            ...
            <input type="text" class="form-control" id="adrs" placeholder="1234 Main St" name="adrs">
          </div>
          ...
          <div class="col-sm-6">
            ...
            <input type="text" class="form-control" id="inputHome" name="mobile_2" placeholder="Home Phone" onkeyup="validateMobileNumber('inputHome', 'inputmethod')">
          </div>
          ...
          <div class="col-sm-6">
            ...
            <select id="inputmethod" class="form-select" name="mthd">
              <option value = 'passive' selected>Select...</option>
          ...
          <div class="col-sm-6">
            ...
            <select id="inputReffer" class="form-select" name="rfrd">
              <option  value="self" selected>Select...</option>
