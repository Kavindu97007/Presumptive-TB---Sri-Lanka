    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="col-sm-6">
          ...
          <input type="text" class="form-control" id="inputMobile" name="mobile_1" placeholder="Mobile Number 1">
        </div>

        <div class="col-sm-6">
          <label for="inputHome" class="form-label">Home Phone</label>
          <input type="text" class="form-control" id="inputHome" name="mobile_2" placeholder="Home Phone">
        </div>
