...
include 'phpfiles/db.php';
    $sql = "SELECT `ptId`, `nameGiven`, `nameFamily`, `mobileNo`,`encounter_id`, `status`, `plannedStartDate`, `actualPeriod`, `location` FROM `analytics`,`encounter` WHERE analytics.ptId=encounter.subject AND analytics.ptId=" .$_SESSION['ptId'] ." ORDER BY encounter.dateCreated DESC LIMIT 1";
...
<script>
  ...
  function generatePDF() {
    ...
    var options = {
      margin: 10,
      filename: '<?php echo $row['nameGiven'].' ' .$row['nameFamily']; ?>.pdf',
