...
<head>
	...
	<title>NPTCCD Patient Portal</title>
...
if (!isset($_POST['ptId'])) {
    header("Location: ptPortal");
    exit();
}

include 'phpfiles/db.php';
    $sql = "SELECT * FROM `analytics` WHERE `ptId`=".$_POST['ptId'];
    //echo $sql;
 ...
 ?>
    <div class="container-md">
        ...
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="phpfiles/getAppointmentPt.php" id="regForm">
